...
"button").addClass("close").appendTo(c).clickToggle(function(){if(b("#stickybar").hasClass("maximize")){b("#stickybar").removeClass("maximize").addClass("minimize");b("#hide_bar input").removeClass("close").addClass("expand");io.disconnect();b(".ui-memblist").remove();b(".ui-chatbox").remove();b("div#chatrm").remove();chatroombox=null;for(key in io.uniquesids)key!=io.cfg.userid&&(chatboxManager.delBox(key),b("li#tabcb"+key).remove());idList=[];tabs.tabs("refresh");localStorage.clear();vmstorage={};
localStorage.setItem("init","false");sessionStorage.removeItem("chatroom");sessionStorage.clear()}},function(){b("#stickybar").removeClass("minimize").addClass("maximize");b("#hide_bar input").removeClass("expand").addClass("close");localStorage.clear();io.init(userdata)});uiFooterbarchatroomtab=(this.uiFooterbarchatroomtab=b("<div></div>")).addClass("vmchat_room_bt").prop("id","chatroom_bt").appendTo(a);uiFooterbarchatroomContent=(this.uiFooterbarchatroomContent=b('<div class="inner_bt"></div>')).appendTo(uiFooterbarchatroomtab);
...
else if(0==b("div#chat_room").length){var a=document.createElement("div");a.id="chat_room";document.body.appendChild(a);chatroombox=b("#chat_room").chatroom({id:"chat_room",user:{name:"test"},title:lang.chatroom_header,offset:"20px",messageSent:function(a,c){b("#chat_room").chatroom("option","boxManager").addMsg(a.name,c)}})}});uiFooterbarUserlisttab=(this.uiFooterbarUserlisttab=b("<div></div>")).addClass("vmchat_bar_button").prop("id","user_list").appendTo(a);uiFooterbarUserlistContent=(this.uiFooterbarUserlistContent=
b('<div class="inner_bt"></div>')).appendTo(uiFooterbarUserlisttab);uiFooterbarUserlistIcon=(this.uiFooterbarUserlistIcon=b('<div id="usertab_icon"></div>')).appendTo(uiFooterbarUserlistContent);uiFooterbarUserlistText=(this.uiFooterbarUserlistText=b('<div id="usertab_text"></div>')).appendTo(uiFooterbarUserlistContent).text("Private Chat").click(function(){b("#chat_div").memberlist("option","boxManager").toggleBox()});uiFooterbartabCont=(this.uiFooterbartabCont=b("<div></div>")).attr("id","tabs").addClass("tabs-bottom").appendTo(a);
uiFooterbartabs=(this.uiFooterbartabs=b('<ul class="tabs"></ul>')).appendTo(uiFooterbartabCont);this._setWidth(this.options.width);this.init(this)},destroy:function(){this.element.remove();this._destroy()},_setWidth:function(a){this.uiFooterbar.width(a+"px")}})})(jQuery);(function(b){b.fn.clickToggle=function(a,c){var d=[a,c];this.data("toggleclicked",0);this.click(function(){var a=b(this).data(),c=a.toggleclicked;b.proxy(d[c],this)();a.toggleclicked=(c+1)%2});return this}})(jQuery);(function(b){b.widget("ui.memberlist",{options:{id:null,title:null,user:null,hidden:!1,offset:0,width:230,userSent:function(a){this.boxManager.addUsr(a.name)},boxClosed:function(a){},boxManager:{init:function(a){this.elem=a},addUsr:function(a){var c=this.elem.uiChatboxLog,d=document.createElement("div");c.append(d);if(a){c=document.createElement("a");c.href="#"+a.userid;var e=document.createElement("img");e.src=a.img;c.appendChild(e);e=document.createElement("span");void 0==a.lname&&(a.lname="");
...
"ta"+a.options.id).appendTo(h).keypress(function(c){if(c.keyCode&&c.keyCode==b.ui.keyCode.ENTER)return msg=b.trim(b(this).val()),0<msg.length&&io.send(msg,a.options.id),b(this).val(""),!1}).focusin(function(){k.addClass("ui-chatbox-input-focus");var a=b(this).parent().prev();a.scrollTop(a.get(0).scrollHeight)}).focusout(function(){k.removeClass("ui-chatbox-input-focus")});e.find("*").add(e).disableSelection();c.children().click(function(){a.uiChatboxInputBox.focus()});a._setWidth(a.options.width);
a._position(a.options.offset);a.options.boxManager.init(a);a.options.hidden||d.show();b(b('#tabs ul li[id="tabcb'+a.options.id+'"]')).append(d)},_setOption:function(a,c){if(null!=c)switch(a){case "hidden":c?this.uiChatbox.hide():this.uiChatbox.show();break;case "offset":this._position(c);break;case "width":this._setWidth(c)}b.Widget.prototype._setOption.apply(this,arguments)},_setWidth:function(a){this.uiChatbox.width(a+"px");this.uiChatboxInputBox.css("width",a-14+"px")},_position:function(a){}})})(jQuery);(function(b){b.widget("ui.chatroom",{options:{id:null,title:null,user:null,hidden:!1,offset:20,width:230,messageSent:function(a,b){this.boxManager.addMsg(a.name,b)},boxClosed:function(a){},boxManager:{init:function(a){this.elem=a},addMsg:function(a,c){var d=this.elem.uiChatboxLog,e=document.createElement("div");d.append(e);d=!1;if(a){var f=document.createElement("b");b(f).text(a+": ");e.appendChild(f)}else d=!0;d=document.createElement(d?"i":"span");b(d).text(c);e.appendChild(d);b(e).addClass("ui-chatbox-msg");
b(e).fadeIn();this._scrollToBottom();this.elem.uiChatboxTitlebar.hasClass("ui-state-focus")||this.highlightLock||(this.highlightLock=!0,this.highlightBox())},highlightBox:function(){var a=this;a.elem.uiChatbox.effect("bounce",{times:3},300,function(){a.highlightLock=!1;a._scrollToBottom()})},toggleBox:function(){this.elem.uiChatbox.toggle("slide",{direction:"down"},1E3)},_scrollToBottom:function(){var a=this.elem.uiChatboxLog;a.scrollTop(a.get(0).scrollHeight)}}},toggleContent:function(a){this.uiChatboxContent.toggle();
this.uiChatboxContent.is(":visible")&&this.uiChatboxInputBox.focus()},widget:function(){return this.uiChatbox},_create:function(){var a=this,c=a.options,d=c.title||"No Title",e=(a.uiChatbox=b("<div></div>")).appendTo(document.body).addClass("ui-widget ui-corner-top ui-chatroom").prop("id","chatrm").prop("outline",0).focusin(function(){a.uiChatboxTitlebar.addClass("ui-state-focus")}).focusout(function(){a.uiChatboxTitlebar.removeClass("ui-state-focus")}),f=(a.uiChatboxTitlebar=b("<div></div>")).addClass("ui-widget-header ui-corner-top ui-chatroom-titlebar ui-dialog-header").click(function(a){}).appendTo(e);
(a.uiChatboxTitle=b("<span></span>")).html(d).appendTo(f);var g=(a.uiChatboxTitlebarMinimize=b('<a href="#"></a>')).addClass("ui-corner-all ui-chatbox-icon").prop("role","button").hover(function(){g.addClass("ui-state-hover")},function(){g.removeClass("ui-state-hover")}).focus(function(){g.addClass("ui-state-focus")}).blur(function(){g.removeClass("ui-state-focus")}).click(function(a){c.boxManager.toggleBox();sessionStorage.setItem("chatroom_status","hidden");return!1}).appendTo(f);b("<span></span>").addClass("ui-icon ui-icon-minusthick").text("minimize").appendTo(g);
d=(a.uiChatboxContent=b("<div></div>")).addClass("ui-widget-content ui-chatbox-content ").appendTo(e);(a.uiChatboxLog=a.element).addClass("ui-widget-content ui-chatbox-log").appendTo(d);var h=(a.uiChatboxInput=b("<div></div>")).addClass("ui-widget-content ui-chatbox-input").click(function(a){}).appendTo(d),k=(a.uiChatboxInputBox=b("<textarea></textarea>")).addClass("ui-widget-content ui-chatbox-input-box ui-corner-all").prop("id","ta_chrm").appendTo(h).keydown(function(a){if(a.keyCode&&a.keyCode==
b.ui.keyCode.ENTER)return msg=b.trim(b(this).val()),a={receiver:"chatroom",msg:msg},0<msg.length&&io.send(a),b(this).val(""),!1}).focusin(function(){k.addClass("ui-chatbox-input-focus");var a=b(this).parent().prev();a.scrollTop(a.get(0).scrollHeight)}).focusout(function(){k.removeClass("ui-chatbox-input-focus")});f.find("*").add(f).disableSelection();d.children().click(function(){a.uiChatboxInputBox.focus()});a._setWidth(a.options.width);a._position(a.options.offset);a.options.boxManager.init(a);
a.options.hidden||e.show()},_setOption:function(a,c){if(null!=c)switch(a){case "hidden":c?this.uiChatbox.hide():this.uiChatbox.show();break;case "offset":this._position(c);break;case "width":this._setWidth(c)}b.Widget.prototype._setOption.apply(this,arguments)},_setWidth:function(a){this.uiChatbox.width(a+"px");this.uiChatboxInputBox.css("width",a-14+"px")},_position:function(a){this.uiChatbox.css("left",a)}})})(jQuery);Array.indexOf||(Array.prototype.indexOf=function(b){for(var a=0;a<this.length;a++)if(this[a]==b)return a;return-1});
...
name:d.name+" "+d.lname}));chatboxManager.addBox(d.userid,{dest:"dest"+counter,title:"box"+counter,first_name:d.name,last_name:d.lname});chatboxManager.init({user:d,messageSent:function(a,b,c){$("#"+a).chatbox("option","boxManager").addMsg(b.name,c)}});$("#"+d.userid).chatbox("option").messageSent(d.userid,d,a);$("li[aria-controls='tabcb"+d.userid+"']").addClass("ui-state-highlight");var g=d.userid}e==d.userid&&($("#"+c.userid).chatbox("option").messageSent(c.userid,d,a),g=c.userid);"undefined"==
typeof vmstorage[g]&&(vmstorage[g]=[]);console.log("vmstograge key="+g);vmstorage[g].push({userid:d.userid,name:d.name,msg:a,time:f})}}function statusUpdate(b,a,c){$("#"+b.userid).length&&($("#"+b.userid).chatbox("option").messageSent(b.userid,b,a),$("#ta"+b.userid).prop("disabled",c))}function comman_chatbox_update(b,a){$("div#chat_room").length&&$("#chat_room").chatroom("option").messageSent(b,a)}
function newStatus(b){$.each(b.message,function(a,c){null!=b.newuser&&c.userid==b.newuser&&(statusUpdate(c,"Online",!1),comman_chatbox_update(c,"Online"))})}function createTab(b,a){var c=$("#tabs").tabs(),d=$("div#tabs ul li").length;tabId="tabcb"+b;addTab(c,tabId,d,a)}
